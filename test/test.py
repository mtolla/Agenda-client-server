...
class MyTestCase(unittest.TestCase):
    ...
    def test_server(self):
        ...
        #Test loginManager
        #Login usr,psw
        login_app = loginManager.do_login("carluca", "68c58ddae9e0cde89cf6a0589644b7fb85bc7cec4c9a00e1a52512f9a06c20c4d376a9d1e124fab52da153c13ada4b95282c7756bc747a72fa734676a4eca746")
        if login_app:
            print("Login OK")
        else:
            print("Login ERROR")
        ...
        time.sleep(2)
        login_app2 = loginManager.do_login("carluca", "68c58ddae9e0cde89cf6a0589644b7fb85bc7cec4c9a00e1a52512f9a06c20c4d376a9d1e124fab52da153c13ada4b95282c7756bc747a72fa734676a4eca746")
        ...
        # Test dbManager
        """
        # get_attributes_from_activity
        app = dbManager.get_attributes_from_activity(0)
        if app:
            print ("get_attributes_from_activity OK: ")
            print (app)
        else:
            print ("get_attributes_from_activity ERROR")
        ...
        if app:
         ...
         # get_holydays_from_proj
        app = dbManager.get_holydays_from_proj(0)
        if app:
            print ("get_holydays_from_proj OK")
        else:
            print ("get_holydays_from_proj ERROR")
